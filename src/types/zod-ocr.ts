...
const ProductSchema = z.object({
  ...
  unitPrice: z
    ...
    .nullable()
    .describe(
      "Pris per enhet av produktet eller tjenesten som desimaltall. Kan være skrevet som et helt tall eller med mellomrom mellom hver tusen. Kan være null hvis ikke tilgjengelig"
    ),
  totalPrice: z
    .number()
    .nullable()
    .describe(
      "Totalpris for linjeelementet (quantity * unitPrice) som desimaltall. Kan være skrevet som et helt tall eller med mellomrom mellom hver tusen. Kan være null hvis ikke tilgjengelig"
    )
});
